	...
	function onInit(){
		...
		document.getElementById('searcher2').onkeydown = function(event){ if (event.keyCode == 13) { searchKimser(document.getElementById('searcher2').value); }};
...
*/
		function searchKimser(input) {
		search = input;
		if (document.getElementById('left').src == "./tables/menu/Menu.html"){
			//document.getElementById('left').contentWindow.document.getElementById("classList").selectedIndex = 2;
			//document.getElementById('left').contentWindow.document.getElementById("petList").selectedIndex = 2;
		}
		document.getElementById('right').src="./tables/CodesObjet.html";
	};
